...
namespace OtoSpaMVC.Data.Migrations
{
    ...
    [Migration("20180617060118_bleblab")]
    partial class bleblab
    {
            ...
            modelBuilder.Entity("OtoSpaMVC.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "admin_ID_123456789", AccessFailedCount = 0, ConcurrencyStamp = "eaf6b985-76bd-46cb-85b2-8541c99328fa", Email = "admin@oto.spa", EmailConfirmed = false, LockoutEnabled = false, PhoneNumberConfirmed = false, TwoFactorEnabled = false, UserName = "admin" }
                    );
                });
